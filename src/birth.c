...
"很少有哪种魔法比混沌魔法更不可预测、更难以控制。混沌是代表毁灭的元素，而混沌法术是你能想象到的最可怕的毁灭武器。施法者还可以召唤混沌的原始力量，诱发对手甚至自身的突变。",
"没有什么法术类别比死亡魔法（Death Magic）中的死灵法术更邪恶、更污秽了。这些法术相对难学，但在高等级时，法术赋予施法者凌驾于活物和亡灵之上的力量，然而最强大的法术需要用施法者自己的鲜血作为媒介，通常会在施法过程中伤害到施法者自己。",
"王牌魔法确实拥有令人赞叹的各种传送法术。由于王牌传送门也可用于召唤其他生物，王牌魔法同样拥有一系列令人印象深刻的召唤法术。然而，并非所有的怪物都乐意被王牌使用者强行拉到另一个地方。",
...
"工匠魔法可以强化施法者自身或其装备。这些法术能极大地提升施法者的战斗能力，但无法被直接用来对付敌人。",
"恶魔魔法（Demon）与死亡魔法一样，是一个非常邪恶的领域。它提供各种攻击法术和恶魔般的探测法术。在高等级时，恶魔魔法提供支配恶魔的能力，以及将你自己变形为恶魔的能力。",
"圣战魔法是“正义”的魔法。它包含许多伤害法术，对肮脏和邪恶的怪物效果极佳，但对善良的怪物则效果甚微。",
...
"音乐学徒通过唱歌来影响他们周围的世界。歌曲有两种类型：有些有瞬间效果，而另一些则具有持续效果，直到施法者的 SP（法力）耗尽。但后者有一个限制：一次只能唱一首歌。",
"剑道秘籍上记载了各种战斗技巧。当你学习新的技巧时，必须携带相应的秘籍，但一旦你将它们熟记于心，就不需要再把它们带在身上了。使用这些技巧时，必须装备一把武器。",
