...
static _res_info_t _resist_map[RES_MAX] = {
    { "强酸",           TERM_GREEN,   OF_RES_ACID,    OF_VULN_ACID,   OF_IM_ACID },
    { "闪电",    TERM_BLUE,    OF_RES_ELEC,    OF_VULN_ELEC,   OF_IM_ELEC },
    { "火焰",           TERM_RED,     OF_RES_FIRE,    OF_VULN_FIRE,   OF_IM_FIRE },
    { "寒冰",           TERM_L_WHITE, OF_RES_COLD,    OF_VULN_COLD,   OF_IM_COLD },
    ...
    { "碎片",         TERM_L_UMBER, OF_RES_SHARDS,  OF_VULN_SHARDS, OF_INVALID },
