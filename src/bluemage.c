...
class_t *blue_mage_get_class(void)
{
    ...
    skills_t xs = {  7,  15,  11,   0,   0,   0,   6,   7};
        ...
        me.name = "青魔法师";
        me.desc = "和所有的法师一样，青魔法师依赖魔法而不是肌肉；但他们获取新法术的方式非常独特，因为他们是从怪物身上学习，而不是从书本上学习。青魔法师的主要施法属性是智力(Intelligence)。\n \n青魔法师可以学习并施展怪物的法术、召唤术甚至远程攻击，将它们作为自己的法术；这项技术被称为青魔法。青魔法师会永久记住他们的法术，但要学习一个法术，他们必须在开启“学习”职业能力时被该法术直接击中。正因为这种要求，青魔法师永远无法学习像加速或治疗这种只作用于怪物自身的法术。";
