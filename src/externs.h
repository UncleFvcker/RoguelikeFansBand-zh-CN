...
extern s16b running;
extern s16b resting;
extern bool resting_resume_quick_walk;
extern s16b cur_hgt;
extern s16b cur_wid;
...
extern cptr artifact_display_name(int a_idx);
extern cptr body_display_name(int b_idx);
extern cptr dungeon_display_name(int d_idx);
extern cptr ego_display_name(int e_idx);
extern cptr kind_display_name(int k_idx);
extern cptr kind_flavor_display_name(int k_idx);
...
extern bool    ethereal_mimic_martial_is_active(void);
extern int     ethereal_mimic_martial_level(void);
extern int     ethereal_mimic_martial_hit_bonus(void);
extern int     ethereal_mimic_martial_damage_bonus(void);
extern int     ethereal_mimic_martial_extra_chance(void);
extern int     ethereal_mimic_martial_ac_bonus(void);
extern int     ethereal_mimic_martial_speed_bonus(void);
