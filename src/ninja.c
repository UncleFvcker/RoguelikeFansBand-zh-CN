...
class_t *ninja_get_class(void)
{
    ...
    skills_t xs = { 15,  10,  10,   0,   0,   0,  25,  11 };
        ...
        me.name = "忍者";
        me.desc = "忍者是潜伏在黑暗中可怕的刺客。他们能在没有光源的情况下有效导航，对敌人进行出其不意的袭击，并能一击必杀。忍者可以使用忍术，擅长寻找隐藏的陷阱和门、解除陷阱以及撬锁。由于重甲、重型武器或盾牌会极大地限制他们的行动，他们更喜欢轻便的衣服，并在升级时变得更快、更隐蔽。忍者无所畏惧，在高级别时几乎对毒素免疫，并能识破隐形。敏捷决定了忍者使用忍术的能力。\n\n忍者可以使用忍术进行潜伏和奇袭。随着等级的提升，他们会获得更多的忍术技巧。他们拥有一项职业能力——“缩地(Quick Walk)”——可以让他们行走的速度极快。";
