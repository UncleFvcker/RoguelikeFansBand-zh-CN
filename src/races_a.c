...
race_t *archon_get_race(void)
{
    ...
    {
        me.name = "神使";
        me.desc = "神使是天使中的更高阶层。他们精通所有的技能，强壮、睿智，并且受到所有人的喜爱。他们能够识破隐形事物，他们的翅膀使他们能够安全地飞越陷阱和其他危险的地方。然而，因为属于更高的位面，这个世界的经历无法在他们身上留下深刻的印记，因此他们升级很慢。";
...
race_t *beastman_get_race(void)
{
    ...
    {
        me.name = "兽化人";
        me.desc = "这个种族是混沌产生的亵渎可憎之物。它并非一个独立的种族，而是一种被混沌扭曲的类人生物，通常是人类；或者是一种人类与野兽梦魇般的混血产物。所有的兽化人都极为习惯混沌，以至于他们不受混乱和声音的困扰，尽管纯粹的混沌之源(Logrus)仍然能伤害他们。兽化人沉迷于混沌之中，因为混沌会越来越深地扭曲他们。兽化人极易发生变异：当他们被创建时，会获得一个随机变异，并且每次升级时都有很小的几率获得更多的变异。与普通种族不同，兽化人可以拥有许多变异，而不会对他们的再生能力产生负面影响。";
...
static cptr _draconian_breath_desc(void)
{
    ...
    case DRACONIAN_GOLD: return "声波";
    case DRACONIAN_SHADOW: return "虚空";
    }
    return 0;
}
...
race_t *dwarf_get_race(void)
{
    ...
    {
        me.name = "矮人";
        me.desc = "矮人是传说中固执的矿工和战士。他们往往强壮而坚韧，但缺乏敏捷。由于他们非常固执并且也有几分智慧，矮人对施加在他们身上的邪恶诅咒相对较有抵抗力。他们非常擅长战斗、搜索和察觉，并能抵抗失明，但他们的潜行能力之差是出了名的。";
...
race_t *high_elf_get_race(void)
{
    ...
    {
        me.name = "高等精灵";
        me.desc = "高等精灵是一个从时间伊始就存在的不朽种族。他们精通所有的技能，强壮而聪明，尽管他们的感知有时值得怀疑。高等精灵从出生起就能识破隐形事物，并且像普通精灵一样抵抗光照效果。然而，很少有事物是他们没有见过的，因此他们很难提升新的等级。";
