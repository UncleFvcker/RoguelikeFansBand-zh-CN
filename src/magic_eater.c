...
class_t *magic_eater_get_class(void)
{
    ...
    skills_t xs = {  7,  16,  10,   0,   0,   0,  13,  11 };
        ...
        me.name = "食魔者";
        me.desc = "食魔者可以吸收魔法装置。一旦被吸收，这些装置将像普通物品一样发挥作用，并在有充能时随时可以使用。实际上，这就像食魔者拥有了用于存放装置的额外物品栏。然而，被吸收的魔法不能像普通装置那样被吸取法力，这些物品也不会被破坏。每种装置的槽位数量是有限的，一旦槽位用完，食魔者将需要选择替换哪个物品。被吸收的魔法不能通过卷轴、法术、药水或物品激活来充能；食魔者必须休息才能恢复充能。被吸收的装置恢复充能的速度受再生能力影响。";
